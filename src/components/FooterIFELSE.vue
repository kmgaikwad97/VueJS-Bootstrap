...
<footer>
    <div class="container grey-footer">
        <div class="row justify-content-evenly align-items-center footer">
            <div class="nav footer-column-1 flex-column col-sm-12 col-md-4 text-center">
                <router-link class="nav-link active" aria-current="page" to="/">
                    <img src="../assets/images/logo.svg" style="width: 40%" class="img-fluid" alt="" />
                </router-link>
          ...
          > -->
                ...
                <router-link class="nav-link datalink" v-if="home" @click="change('Home')" to="/">Home</router-link>
                <router-link class="nav-link datalink" v-if="about" @click="change('About')" to="/about">About</router-link>
                <router-link class="nav-link datalink" v-if="service" @click="change('Service')" to="/services">Services</router-link>
                <router-link class="nav-link datalink" v-if="contact" @click="change('Contact')" to="/contact">Contact</router-link>
            </div>
